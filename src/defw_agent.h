...
#define IFW_AGENT_STATE_ALIVE (1 << 0)
#define IFW_AGENT_CNTRL_CHANNEL_CONNECTED (1 << 1)
#define IFW_AGENT_RPC_CHANNEL_CONNECTED (1 << 2)
#define IFW_AGENT_WORK_IN_PROGRESS (1 << 3)
#define IFW_AGENT_STATE_DEAD (1 << 4)
#define IFW_AGENT_STATE_NEW (1 << 5)
